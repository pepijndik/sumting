<template>
  ...
  <div class="w-50 m-5">
    <div class="mb-4 text-sm text-gray-600 " v-show="! recovery">
      Bevestig de toegang tot uw account door de authenticatiecode in te voeren die door uw authenticatietoepassing is verstrekt.
    </div>
...
<!--        <input-component id="one-time-code"-->
<!--                         ref="one-time-code"-->
<!--                         placeholder=""-->
<!--                         autocomplete=""-->
<!--                         type="text"-->
...
<!--                         v-model="code" />-->
      ...
      <div class="flex items-center justify-end mt-4">
        <Button type="submit" class="ml-4 w-full">
          Inloggen
        </Button>
      </div>
