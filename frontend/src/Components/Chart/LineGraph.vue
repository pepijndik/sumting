...
export default {
  ...
  computed: {
    /**
     * Returns the total number of orders of the past 30 days
     * @returns {string}
     */
    firstMonth() {
  ...
  async created() {
    /**
     * Fetches the total number of orders of the past 30 days
     *
     * @type {*}
     */
    ...
    /**
     * Fetches the total number of orders of 3 months prior over the span of 30 days
     * @type {*}
     */
    ...
    /**
     * Adds the current month data to the chart data
     *
     * @type {number[]}
     */
