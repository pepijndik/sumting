    ...
    <div class="focus:outline-none focus:ring-2 focus:ring-offset-2 md-flex-col flex-row
      ...
      <div class="w-1/3 flex items-center">
        <div class="md-flex-row flex-col">
          ...
          <InputComponentNumeric :inputData="this.OrderLine.amount" @update="this.OrderLine.amount = $event" id="amount"
                                 placeholder="Amount"
                                 :min="1"
...
export default {
  ...
  methods: {
    /**
     * Emit the update to the parent component for updating the orderline
     */
    emitUpdate() {
  ...
  watch: {
    ...
    /**
     * Watch for changes in the amount and update the line total
     */
    amount: function () {
