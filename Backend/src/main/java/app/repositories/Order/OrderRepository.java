...
public class OrderRepository implements CustomCrudRepository<Order, Integer> {
    ...
    public Iterable<Order> findByClient(Integer id) {
        return em.createQuery("SELECT DISTINCT o FROM Order o FULL JOIN OrderLine ol ON ol.order.id = o.id WHERE ol.owner.id = :id", Order.class)
            .setParameter("id", id)
            .getResultList();
    }
    ...
    public Iterable<Order> findByProject(Integer projectID) {
        ...
        return em.createQuery("SELECT DISTINCT o FROM Order o FULL JOIN OrderLine ol ON ol.order.id = o.id WHERE ol.product.id = :productID", Order.class)
    ...
    public Iterable<Order> findByClientAndProject(Integer clientID, Integer projectID) {
        ...
        return em.createQuery("SELECT DISTINCT o FROM Order o INNER JOIN OrderLine ol on ol.order.id = o.id WHERE ol.owner.id = :clientID AND ol.product.id = :productID", Order.class)
